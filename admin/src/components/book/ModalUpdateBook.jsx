...
import { Avatar, Button, FormControlLabel, Grid, MenuItem, Modal, Switch, TextField, Typography, useMediaQuery } from '@mui/material';
import { Box } from '@mui/system';
import { makeAdmin,  removeAdmin,  updateUser } from '../../store/userSlice';
...
const ModalUpdateBook = ({open,handleClose}) => {
    const isNonMobile = useMediaQuery("(min-width:600px)");
      ...
      const handleFormSubmit = (values) => {
        ...
        console.log(CategorySelected,AuthorSelected);
