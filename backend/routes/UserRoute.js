const { signup, getUsers, login, updateSubscription, updateProfile, changePassword, viewProfile, deleteAccount, makeAdmin, removeAdmin, blockUser, unblockUser } = require("../controllers/UserController");
